...
import 'package:superfood_admin_web_portal/widgets/simple_appbar.dart';
...
class _AllVerifiedUsersScreenState extends State<AllVerifiedUsersScreen> {
                ...
                onPressed: ()
                {
                      ...
                      .then((value)
                  {
                    ...
                    SnackBar snackBar = const SnackBar(
                      content:  Text("Bloced Successfully.",
                        style:  TextStyle(
                          fontSize: 36,
                          color: Colors.black,
                        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "All Verified Users Acounts",),
      body: Center(
        child: Container(
